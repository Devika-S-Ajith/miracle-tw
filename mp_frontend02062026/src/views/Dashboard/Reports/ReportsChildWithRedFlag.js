...
export default function ReportsChildWithRedFlag() {
  ...
  const getTableConfig = (role) => {
    if (role !== "superadmin") {
      return [
        ...
        {
          key: "lastThriveScaleDate",
          render: (item) => item.lastThriveScaleDate,
        },
        {
        ...
        },
        {
          ...
          render: (item) =>
            item["HT_childPlacementStatus.placementStatus"] || "-",
        },
  ...
  return (
    <>
      ...
      >
        <ReportHeader reportHeaderText={t("common:common.RedFlags")} />
        <ReportExportButton
              ...
              <Card sx={{ mr: 1, p: 3 }}>
                ...
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <Box display="flex" flexWrap="wrap" gap={3}>
                    ...
                    {countryFilter &&
                      getSelectedCountryDetails(locationList, countryFilter)
                        ?.districtRequired && (
                        <Box mt={-2}>
                          <TextField
                            fullWidth
