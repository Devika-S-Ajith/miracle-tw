          ...
          {signedinUserRoleHT === "superadmin" && (
            <IconButton
              ...
              sx={{
                ...
                "&.Mui-disabled img": { filter: "grayscale(1)", opacity: 0.55 },
              }}
            >
              <img alt="filter_accounts" src="/static/icons/filterIcon.svg" width={20} height={17} style={{ alignSelf: "center" }} />
              {filtersApplied && (
                <div style={{ position: "absolute", top: 5, right: 5, width: 8, height: 8, borderRadius: "50%", backgroundColor: loading ? "#A8A8A8" : "#1D334B" }} />
              )}
            </IconButton>
          )}
