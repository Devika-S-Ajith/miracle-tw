...
const AddUserForm = (props) => {
  ...
  const value = organizationList.filter((item) =>
    item.id == fromOrg ? orgNumber : currentOrganization
  )[0]?.HTOrganizationTypeId;
  ...
  useEffect(() => {
    setOrgTypeId(
      organizationList.filter(
        (item) => item.id == (fromOrg ? orgNumber : signedinOrgId)
      )[0]?.HTOrganizationTypeId
    );
  }, [organizationList]);
                ...
                <Grid container spacing={3}>
                  ...
                  <Grid item md={12} xs={12}>
                    <NumberFormat
                      ...
                      label={
                        values.country?.length === 0 || values.country == null
                          ? `${t(
                              "common:common.Select Country to Enter Phone"
                            )}`
                  ...
                  <Grid item md={6} xs={12} sx={{ mt: -2 }}>
                    <Field
                      ...
                      options={
                        locationList &&
                        locationList.states &&
                        locationList.states.length &&
                        locationList.states.filter(
                          (item) => item.HTCountryId === values.country
                        )
                      }
                      textFieldProps={{
                        fullWidth: true,
                    ...
                    <Field
                      ...
                      options={
                        orgTypeId == 1
                          ...
                          : roleList &&
                            roleList.length &&
                            roleList.filter((item) => item.id != "1")
                      }
                      disabled={fromOrg}
                      textFieldProps={{
                        fullWidth: true,
