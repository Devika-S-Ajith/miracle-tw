...
function AverageThriveScaleScore() {
  ...
  const ClearFilters = () => {
    ...
    useEffect(() => {
    document.title = "Reports | Average Thrive Scale Scores | Miracle Foundation"
    if(initialData===null)
    {
        getAverageThriveScale();
    }
    ...
    const handleExport = useCallback(async () =>{
      try {
        ...
        let payload ={
          "moduleType": "report",
          "needFullData": "true",
          "subModuleType": "averageThrivescale",
         }
        ...
        >
            ...
            <Table>
                ...
                <TableBody key={index}>
                    ...
                    <TableCell>
                     {item.FamilyandSocialRelationshipsScore}
                    </TableCell>
                    <TableCell>
                    {item.HealthAndMentalHealthScore}
                    </TableCell>
                    <TableCell>
                    {item.HouseholdEconomyScore} 
                    </TableCell>
                    <TableCell>
                    {item.LivingConditionsScore} 
                    </TableCell>
                    <TableCell>
                    {item.lastDate}
                    </TableCell>  
...
export default AverageThriveScaleScore;
