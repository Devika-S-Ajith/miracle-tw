...
function ReportsChildrenInCaseManagement() {
    ...
    useEffect(() => {
        document.title = "Reports | Children in Case Management | Miracle Foundation"
        if(initialData===null)
        {
            getNewlyAddedChildrenApi();
        }
            ...
            >
              ...
              <ChevronLeftIcon fontSize="small" />
                ...
                <Typography
                    ...
                    variant="h5"
                >
                    {t('common:common.Children in Case Management')}
            ...
            <Table>
                ...
                <TableBody key={index}>
                    <TableRow >
                      ...
                      <TableCell>
                        {item.childPlacementStatus}
                      </TableCell>
                      <TableCell>
                        {item.dateofLastThriveScale}
                      </TableCell>
                    </TableRow>      
                </TableBody>
                 )})}
