...
function ReportsFamilyServed() {
  ...
  const getTableConfig = (role) => {
    if (role !== "superadmin") {
      ...
      return [{ key: "familyId", render: (item) => item.familyId }];
    }
  };
  ...
  return (
    <>
      ...
      >
        <ReportHeader reportHeaderText={t("common:common.FamiliesAssessed")} />
        <ReportExportButton
...
export default ReportsFamilyServed;
