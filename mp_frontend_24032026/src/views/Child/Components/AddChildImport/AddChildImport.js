   ...
   const getHeaderValue = useCallback(async (id) => { 
        try {
            ...
            if (data) {
                ...
                setChildHeader(data.data.entityProperties);
                setLoading(false)
                       ...
                       <Table>
                           ...
                           <TableBody sx={{mb:4}}>
                               <TableRow sx={{mb:4}}>
                                   ...
                                   <TextField inputProps={{style: {fontSize: '12pt',fontWeight:"bold"}}} InputProps={{ disableUnderline: true }} value="Child Field" variant="standard"/>
                           ...
                           {childHeader&& childHeader.length >0 && childHeader.map((item,index)=>(
                           <TableBody sx={{mt:4}}>
                               { item.isMandatory ? 
