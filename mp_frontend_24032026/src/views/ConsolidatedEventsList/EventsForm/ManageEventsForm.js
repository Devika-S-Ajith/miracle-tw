...
import { combineTimeDate, DateFormatFromRegion, dateFormatter, formatTime, fromUtc, toUtc } from "../../../constants";
import APIS from "../../../common/hooks/UseApiCalls";
import { fileUpload, generateUniqueKeyForImage } from "../../../helpers/helperFunction";
...
const EventDetailForm = ({ close, eventData, onSuccess }) => {
  ...
  useEffect(() => {
    const getFamilyList = async () => {
      ...
      try {
        const res = await APIS.GetFamilyList(params);
