     ...
     <Box sx={{ width: '100%' }}>
      {!showAttachedLabel && (
        <Box sx={{ marginBottom: 1 }}>
          <CustomFieldLabel>
            {required ? `${t("common:common.Phone Number")}*` : t("common:common.Phone Number")}
          </CustomFieldLabel>
        </Box>
      )}
    <TextField
      fullWidth
      variant="outlined"
      label={showAttachedLabel ? t("common:common.Phone Number") : ""}
      color="primary"
      placeholder={showAttachedLabel ? t("common:common.Phone Number") : ""}
      value={inputValue}
